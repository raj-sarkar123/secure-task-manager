...
import { Shield, User, Mail, Lock, Eye, EyeOff, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response?.data?.errors?.length > 0) {
                ...
                setError(err.response?.data?.message || 'We encountered an error creating your account.');
            }
        } finally {
            setIsLoading(false);
        }
